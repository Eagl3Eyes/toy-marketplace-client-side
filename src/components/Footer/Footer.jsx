...
const Footer = () => {
    return (
        <div className="flex items-center justify-center bg-[#181818]">
            <div className="container">
                <footer className="footer px-10 pt-10 text-white">
                    <div>
                        <img src="/logo.png" className='h-12 max-[380px]:h-10 mx-auto' />
                        <a className="btn hover:bg-transparent btn-ghost normal-case text-3xl font-extrabold text-black" href="/">
                            ...
                            <label className="cursor-pointer font-extrabold text-slate-600">izz</label> </a>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <a className="link link-hover">Phone : 01983124525</a>
                        <a className="link link-hover">Email : tuhinjobayergolap007@gmail.com</a>
                        <a className="link link-hover">Address : Dhaka , Kuril.</a>
                    </div>
                    <div>
                ...
                <footer className="footer footer-center py-5 text-white">
                    <div>
                        <p>Copyright © 2023 - ToyBizz . All rights reserved.</p>
                    </div>
                </footer>
            </div>
        </div>
